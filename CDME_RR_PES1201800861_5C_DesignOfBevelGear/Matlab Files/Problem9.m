%% 
% Program for Design of Bevel Gear, Problem 9.
% 
% Problem Statement: A pair of straight tooth bevel gears at right angles is 
% to transmit 5kW at 1500 rpm of the pinion at a speed raio of 3. Diameter of 
% pinion is 75 mm. The tooth form is 14.5 degrees involute p. Pinion is made of 
% steel (S_d =160 MPA) and gear of CI(S_d =80 MPA). Design the gear pair and check 
% the design for dynamic load wear.
% 
% Date: 21/10/2020
% 
